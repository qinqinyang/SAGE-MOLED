...
from network.R2AttUNet_T2 import Inference, FeatureExtractor
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='./dataset_sage/')
    ...
    parser.add_argument('--DATA_C', type=int, default=12)
    ...
    parser.add_argument('--lr_updata', type=int, default=200000)  # epoch num for lr updata
