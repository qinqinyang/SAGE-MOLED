...
srcUrl = 'scan_t2t2star_new/';
fieldUrl = ['scan_t2t2star_new_field/'];
vobjUrl = 'Template_SMRI_T2T2star/';
dstUrl = 'train_t2t2star_new/';
topname='brain_';
...
for index = start_index:end_index
    ...
    ksp_echo1 = rot90(k1_ori_kspace(:,1:PHASE_NUM),4);
    ...
    ksp_echo2 = rot90(k2_ori_kspace(:,1:PHASE_NUM),4);
    ksp_echo2 = flip(ksp_echo2,2);
    ...
    current_out(5,:,:) = T2;
    current_out(6,:,:) = T2star;
    current_out(7,:,:) = M0;
    current_out(8,:,:) = B0.*mask;
    current_out(9,:,:) = B1.*mask;
