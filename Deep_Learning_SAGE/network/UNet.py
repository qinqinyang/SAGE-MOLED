...
class Inference_4(nn.Module):
    def __init__(self, img_ch=3, output_ch=1,filter_dim=64):
        super(Inference_4, self).__init__()
        ...
        self.Conv11 = outconv(64, 1)
        self.Conv12 = outconv(64, 1)
    ...
    def forward(self, x):
        ...
        T2 = self.Conv11(d2)
        R = self.Conv12(d2)
        out = torch.cat((T2, R), dim=1)

        return out

class Inference_3(nn.Module):
    def __init__(self, img_ch=3, output_ch=1,filter_dim=64):
        super(Inference_3, self).__init__()
...
class Inference_2(nn.Module):
    def __init__(self, img_ch=3, output_ch=1,filter_dim=64):
        super(Inference_2, self).__init__()
