...
%%
figure(21);
subplot(1,4,1);imshow(ktrans,[0 0.4]);title('Kt');colorbar;
subplot(1,4,2);imshow(Fp,[0 1.5]);title('Fp');colorbar;
subplot(1,4,3);imshow(ve,[0 1]);title('Ve');colorbar;
subplot(1,4,4);imshow(Tc,[0 0.5]);title('Tc');colorbar;
colormap jet;