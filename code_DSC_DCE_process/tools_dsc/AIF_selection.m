function [AIF_fit,x,y] = AIF_selection(data,TR,showtime,r2)
...
mask = ones(nR,nP);
[Ct,S0] = caculate_Ct(data_r,mask,nSamplesMax,r2);

%%
figure;imagesc(squeeze(data_r(:,:,showtime)),[0 0.2]);colormap jet;axis image;
[x,y]=getpts;
...
AIF_fit=GVfunction(fitParameters,options);

%%
figure;
plot(aif_cuv);hold on;
plot(AIF_fit);
